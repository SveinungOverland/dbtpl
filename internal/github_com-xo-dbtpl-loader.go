// Code generated by 'yaegi extract github.com/SveinungOverland/dbtpl/loader'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/SveinungOverland/dbtpl/loader/loader"] = map[string]reflect.Value{
