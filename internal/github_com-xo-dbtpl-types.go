// Code generated by 'yaegi extract github.com/SveinungOverland/dbtpl/types'. DO NOT EDIT.

package internal

import (
	"github.com/SveinungOverland/dbtpl/types"
	"reflect"
)

func init() {
	Symbols["github.com/SveinungOverland/dbtpl/types/types"] = map[string]reflect.Value{
